...
(function(jQuery)
{
  ...
  jQuery.railsAutocomplete.fn.extend({
    init: function(e) {
      ...
      function extractExtraFieldData(e) {
        var extra_fields = $.parseJSON($(e).attr('data-extra-fields')) || {};
        for (var key in extra_fields) {
          extra_fields[key] = $(extra_fields[key]).val();
        }
        return extra_fields;
      }
      ...
      $(e).autocomplete({
        source: function( request, response ) {
          var data  = extractExtraFieldData( e );
          ...
          if (e.delimiter != null) {
            ...
            if ($(this).attr('data-update-elements')) {
              ...
              for (var key in update_elements) {
                $(update_elements[key]).val(data[key]).text(data[key]).trigger('change');
              }
            }
          }
